...
try {
    ...
    // Temp-Verzeichnis lokal anlegen – Binary schreibt direkt hierhin
    ...
    // Binary direkt lokal aufrufen – kein SSH nötig, da PHP und Rust auf demselben Host laufen
    $procCmd = ['/opt/sf-api/run_fetch_wrapper.sh'];
