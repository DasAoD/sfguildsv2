...
**Aktuell getestete sf-api Version: v0.4.4** (kompatibel mit S&F-Server v30.500)
...
cp rust_examples/character_sync.rs      /root/sf-api/examples/
cp rust_examples/guild_battle_time.rs   /root/sf-api/examples/
cd /root/sf-api
...
cargo build --release --example character_sync
cargo build --release --example guild_battle_time
...
cp target/release/examples/character_sync      /opt/sf-api/
cp target/release/examples/guild_battle_time   /opt/sf-api/
chown root:www-data /opt/sf-api/fetch_guild_reports /opt/sf-api/list_chars /opt/sf-api/member_sync /opt/sf-api/character_sync /opt/sf-api/guild_battle_time
chmod 750           /opt/sf-api/fetch_guild_reports /opt/sf-api/list_chars /opt/sf-api/member_sync /opt/sf-api/character_sync /opt/sf-api/guild_battle_time
```
