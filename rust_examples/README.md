...
chown root:www-data /opt/sf-api/fetch_guild_reports /opt/sf-api/list_chars /opt/sf-api/member_sync /opt/sf-api/character_sync
chmod 750           /opt/sf-api/fetch_guild_reports /opt/sf-api/list_chars /opt/sf-api/member_sync /opt/sf-api/character_sync
```
